  ...
  return (
    <SafeAreaView style={styles.container}>
      {loadingCoords ? (
        ...
        >
          <Marker coordinate={coords as Coords} title="Current Location">
            <Image
          ...
          {technicians
            .filter(
              (technician) =>
                ...
                technician.services.some(
                  (service) => service === parseInt(id as string)
                ) &&
        ...
        <View style={styles.callModalContainer}>
          <View style={styles.callModalContent}>
            {isCalling && !inCall && !incomingCall && (
              <>
                <Text style={styles.callModalText}>
                  Calling {selectedTechnician?.firstName}
                </Text>
                <Image
                  source={{ uri: selectedTechnician?.photo }}
            ...
            {inCall && !incomingCall && (
              <>
                <Text style={styles.callModalText}>
                  In call with {selectedTechnician?.firstName}
                </Text>
                <Image
                  source={{ uri: selectedTechnician?.photo }}
                  style={styles.callPhoto}
