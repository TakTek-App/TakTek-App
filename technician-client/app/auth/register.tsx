...
import { SafeAreaView, TextInput, Text, StyleSheet, TouchableOpacity, View, Image, Modal, ScrollView, ActivityIndicator, KeyboardAvoidingView, Platform } from 'react-native';
...
const RegisterScreen = () => {
    ...
    const handleRegister = async () => {
        ...
        try {
            await signUpTechnician(firstName, lastName, email, company, password);
            showModal('Finalize your registration', 'Please complete the service delivery information');
        } catch (error) {
